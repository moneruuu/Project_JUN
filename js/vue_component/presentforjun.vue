...
<script>
  module.exports = {
    data: function(){
      return {
        gsrc: "./images/"+gdrinkdata["f_i_imgsrc"],
        error: ""
      }
    },
    methods: {
      confirm() {
        ...
        if(check){
          charge = "{present for jun}"
          execPHPAsync("processBoughtDrinkByPresent.php", gdrinkdata["f_i_id"], playerid,4);
          increasedfav = "♥♥♥♥";
