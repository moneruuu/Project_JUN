...
<div class="flexcontainer_button">
  <div id="drink_button_Y" v-on:click='btn("/presentconfirm")'><br>プレゼントを使って購入</div>
  <!-- <div id="drink_button_N" v-on:click='btn("/presentbuy")'><br>プレゼントとして購入</div> -->
</div>
...
<script>
  module.exports = {
    data: function(){
      return {
        name: gdrinkdata["name"],
        vol: gdrinkdata["vol"],
        remaining: execPHP("getItemValueFromPInv.php", playerid, gdrinkdata["drinkid"]),
        price: gdrinkdata["price"],
        icon: "./images/"+gdrinkdata["imgsrc"],
        error:""
      }
    },
    methods: {
